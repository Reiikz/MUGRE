package com.reiikz.robotdriver.main;
...
import com.reiikz.robotdriver.network.DataSenderManager;
import com.reiikz.robotdriver.network.NetworkData;
import com.reiikz.robotdriver.network.RoverCommands;
import com.reiikz.robotdriver.network.RoverListener;
	...
	private void initialize() {
		...
		btnReady.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				dsm = new DataSenderManager(new NetworkData(IP, CPORT, 200, 10), listener, sync_listener, logger);
				dsm.sendNockNock();
